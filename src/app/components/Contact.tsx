		...
		<section className={style.section}>
			<div className='text-center'>
				...
				<div className='flex flex-col justify-center text-center items-center'>
					<ol
						className={`list-none flex items-center gap-14 mr-14 ${style.contactsList}`}
					>
						<li className={`flex items-center ${style.addressText}`}>
						...
						<li className={`flex items-center ${style.phoneText}`}>
